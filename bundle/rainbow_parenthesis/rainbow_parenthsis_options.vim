...
"	   $Id: rainbow_parenthsis_options.vim 51 2007-10-09 18:43:58Z krischik@users.sourceforge.net $
"    Copyright: Copyright (C) 2006 Martin Krischik
"   Maintainer:	Martin Krischik (krischik@users.sourceforge.net)
"      $Author: krischik@users.sourceforge.net $
"	 $Date: 2007-10-09 20:43:58 +0200 (Tue, 09 Oct 2007) $
"      Version: 4.0
"    $Revision: 51 $
"     $HeadURL: http://vim-scripts.googlecode.com/svn/trunk/1561%20Rainbow%20Parenthsis%20Bundle/rainbow_parenthsis_options.vim $
